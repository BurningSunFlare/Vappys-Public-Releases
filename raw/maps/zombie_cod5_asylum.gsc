...
main()
{
	level.Uses_Pap = true; level.PapCost = 5115; level.Pap_Origin = ( -810, 142, 266 );
	level.Uses_Fizz = true; level.Fizz_Origin = ( 598, 964, 272 );
	level.Uses_Upgrade = true;level.Upgrade_Origin = ( 1308, 668, 125 );
