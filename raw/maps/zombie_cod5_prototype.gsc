...
main()
{
	...
	include_powerups();
	level.zones = [];
	level.Uses_Pap = true; level.PapCost = 5000; level.Pap_Origin = ( 1130, 820, 151 );
	level.Uses_Fizz = true; level.Fizz_Origin = ( -176, 492, 178 );
	level.Uses_Upgrade = true;level.Upgrade_Origin = ( -190, 897, 13 );
