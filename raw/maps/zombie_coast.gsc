...
main()
{
	...
	level.Uses_FizzyHUD = true;
	level.Ice_Origin = (165.342, -1387.05, -35.0548); level.Ice_Angles = (0, 200, 0); level.VanBull = 12;
	level.Fizzy_Origin = (-752, -838, 76); level.Fizzy_Angles = (0, 180, 0); level.VanHud = 1;
	level.Uses_Upgrade = true;level.Upgrade_Origin = (-865,-1051,382);
...
coast_spawn_init_delay(director)
{
	...
	director_zomb waittill_notify_or_timeout( "director_spawn_zombies", 3 );
	//wait(30.0);
