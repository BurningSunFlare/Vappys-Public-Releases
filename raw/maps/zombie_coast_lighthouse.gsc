...
pack_a_punch_move_to_spot()
{
	...
	if(IsDefined(level.VanillaPlus)){
	link_ent.origin = (-3478,1131,207);
	link_ent moveto (-3478,1131,207);
	pap_machine_trig.origin = (-3478,1131,207);
	pap_bump_trig.origin = (-3478,1131,207);
	pap_jingle_struct = (-3478,1131,207);
	}
	...
	pap_machine_trig.origin = (-3478,1131,207);
	pap_bump_trig.origin = (-3478,1131,207);
	pap_jingle_struct.origin = (-3478,1131,207);
	for(i=0;i<pap_pieces.size;i++)
	{
		if(isDefined(pap_pieces[i].target))
		{
