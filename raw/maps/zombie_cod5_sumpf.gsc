...
main()
{
	...
	FizzLocation = [];
	FizzLocation[0] = ( 8363, 3677, -614 );
	FizzLocation[1] = ( 11551, 3311, -626 );
	FizzLocation[2] = ( 12632, -1170, -600 );
	FizzLocation[3] = ( 7386, -1447, -617 );
	level.Uses_Pap = true; level.PapCost = 5000; level.Pap_Origin = ( 11343, -2012, -698 );
	level.Uses_Fizz = true; level.Fizz_Origin = FizzLocation[ RandomIntRange( 0, 3 ) ];
	level.Uses_Upgrade = true;level.Upgrade_Origin = ( -11477, 3098, -612 );
...
include_weapons()
{
	...
	maps\_zombiemode_weapons::add_zombie_weapon( "zombie_type99_rifle", undefined, &"WAW_ZOMBIE_WEAPON_TYPE99_200", 200,	"rifle" );
	maps\_zombiemode_weapons::add_zombie_weapon( "zombie_gewehr43", undefined, &"WAW_ZOMBIE_WEAPON_GEWEHR43_600", 600,	"rifle" );
	maps\_zombiemode_weapons::add_zombie_weapon( "zombie_m1carbine", undefined, &"WAW_ZOMBIE_WEAPON_M1CARBINE_600", 600,	"rifle" );
	maps\_zombiemode_weapons::add_zombie_weapon( "zombie_m1garand", undefined , &"WAW_ZOMBIE_WEAPON_M1GARAND_600", 600,	"rifle" );
	...
	maps\_zombiemode_weapons::add_zombie_weapon( "mine_bouncing_betty", undefined, &"WAW_ZOMBIE_WEAPON_SATCHEL_2000", 2000 );
	maps\_zombiemode_weapons::add_zombie_weapon( "kar98k_scoped_zombie", undefined, &"WAW_ZOMBIE_WEAPON_KAR98K_S_750", 750,	"sniper");
	maps\_zombiemode_weapons::add_zombie_weapon( "zombie_stg44", undefined, &"WAW_ZOMBIE_WEAPON_STG44_1200", 1200, "mg" );
	maps\_zombiemode_weapons::add_zombie_weapon( "zombie_thompson", undefined, &"WAW_ZOMBIE_WEAPON_THOMPSON_1200", 1200, "mg" );
	maps\_zombiemode_weapons::add_zombie_weapon( "zombie_type100_smg", undefined, &"WAW_ZOMBIE_WEAPON_TYPE100_1000", 1000, "mg" );
	maps\_zombiemode_weapons::add_zombie_weapon( "zombie_fg42", undefined, &"WAW_ZOMBIE_WEAPON_FG42_1500", 1500,	"mg" );
	...
	maps\_zombiemode_weapons::add_zombie_weapon( "zombie_bar_bipod", undefined, &"WAW_ZOMBIE_WEAPON_BAR_BIPOD_2500", 2500,	"mg" );
}
include_powerups()
{
