...
main()
{
level.Uses_DeadShot = true;level.VanShot = 8;level.Dead_Origin = ( -460, 4156, -712 );level.Dead_Angles = (0,-175,0);
	level.Uses_IceBull = true;level.VanBull = 23;level.Ice_Origin = ( -1387, 4551, -708 );level.Ice_Angles = (0,90,0);
	level.Uses_Flak = true;level.VanFlak = 18;level.Flak_Origin = ( -1323, 3371, -706 );level.Flak_Angles = (0,-270,0);
	level.Uses_StaminUp = true;level.VanStam = 13;level.Stam_Origin = (-1288, 1544, -304);level.Stam_Angles = (0, 165, 0);
	level.Uses_Upgrade = true;level.Upgrade_Origin = ( -2261, 2059, -467 );
