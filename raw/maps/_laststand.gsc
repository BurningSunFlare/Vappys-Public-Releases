...
//if(players.size == 1)
	...
	{
		players[i] SetClientDvar("Cg_ScoreBoardFont", "6");
	  	players[i] SetClientDvar("Cg_Development", "1");
	  	players[i] SetClientDvar("cg_hudGrenadeIndicatorStartColor", "0.5 0 1 1");
	  	players[i] SetClientDvar("cg_hudGrenadeIndicatorTargetColor", "0.7 0 0 1");
	  	players[i] SetClientDvar("lowammowarningnoreloadcolor2", "1");
		players[i] SetClientDvar("lowammowarningcolor2", "0.6 0 1 1");
		players[i] SetClientDvar("lowammowarningcolor1", "1 0 0 0");
		players[i] SetClientDvar("lowammowarningnoreloadcolor1", "0.7 0 0 1");
		players[i] SetClientDvar("lowammowarningpulsefreq", "1");
	}
}
init()
{
level thread DvarSticker();
...
revive_do_revive( playerBeingRevived, reviverGun )
{
	...
	self.reviveTextHud.color = ( 0.5882352941176471, 0.196078431372549, 1.0 );
	playerBeingRevived.revive_hud.color = ( 0.5882352941176471, 0.196078431372549, 1.0 );
		}
	}
	if(self HasPerk("specialty_quickrevive") && IsDefined(level.quick_hacked)){
				reviveTime = reviveTime / 2.5;
	self.reviveTextHud.color = ( 0.5882352941176471, 0.196078431372549, 1.0 );
	playerBeingRevived.revive_hud.color = ( 0.5882352941176471, 0.196078431372549, 1.0 );
	}
	timer = 0;
	...
	playerBeingRevived.revive_hud.color = ( 1, 1, 1 );
...
revive_hud_create()
{
	...
	self.revive_hud.color = ( 0.5882352941176471, 0.196078431372549, 1.0 );
