...
main()
{
	level.Uses_DeadShot = true;level.VanShot = 8;level.Dead_Origin = (628.821,1239.64,-15.875);level.Dead_Angles = (0,90,0);
	level.Uses_IceBull = true;level.VanBull = 23;level.Ice_Origin = (-1397,1429,168);level.Ice_Angles = (0,180,0);
	level.Uses_Flak = true;level.VanFlak = 18;level.Flak_Origin = (591,-1029,320);level.Flak_Angles = (0,180,0);
	level.Uses_StaminUp = true;level.VanStam = 13;level.Stam_Origin = (-211.98,-535.641,248.125);level.Stam_Angles = undefined;
	level.Uses_Upgrade = true;level.Upgrade_Origin = (965,94,208);
