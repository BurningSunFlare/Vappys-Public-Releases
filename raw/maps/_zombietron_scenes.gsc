...
end_of_game_summary_begin()
{
	...
	{
		players[i] setClientDvars( "player_topDownCamMode", 0, "player_topDownCamCenterPos", camera_center, "player_TopDownCamAngles", camera_angles, "cg_fov", 65, "hud_drawHUD", "0","cl_scoreDraw", "0" );
	}
...
end_of_game_summary_end(lastArena,old_camera_angles,old_camera_offset)
{
	...
	for (i = 0; i < players.size; i++)
	{
		players[i] setClientDvars( "player_topDownCamMode", 0,
